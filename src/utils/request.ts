...
instance.interceptors.request.use(
  (config: AxiosRequestConfig) => {
    ...
    config.headers = {
      Authorization:
        token.authorization ||
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..13xTl3IFys6TamGxBn64zFDKsDBpWZt8gsZGe_rQQwM.1664352659879',
